-- Vercel / browser clients use the Supabase anon key. Ensure every public table
-- and function is accessible to the anon role via grants and permissive RLS.
...
-- Explicit grants for background-process RPCs used before login/session refresh.
